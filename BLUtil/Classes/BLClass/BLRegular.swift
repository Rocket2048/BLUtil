...
public class BLRegular {
    ...
    /// - Returns: 是否OK
    public static func EmailIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func PhoneNumberIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func NumberIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func SpecificNumbersIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func ChineseIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func IllegalCharacterIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func URLIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func BlankLinesIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func QQIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func IDIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func MACIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func IdCardIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func DateInformationIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func AccountLegalIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func PasswordIsValidated(vStr: String) -> Bool {
    ...
    /// - Parameter vStr: 字符串入参
    /// - Returns: 是否OK
    public static func StrongPasswordIsValidated(vStr: String) -> Bool {
